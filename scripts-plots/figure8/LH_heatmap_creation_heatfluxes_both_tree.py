...
data_final_H = np.loadtxt(data_location+'extracted_LH_data_2018_day_only.csv',delimiter=',')
...
plt.tight_layout()
plt.savefig(sav_loc+'Average_total_latent_heat_flux_day_time.png',dpi=400)
plt.close()