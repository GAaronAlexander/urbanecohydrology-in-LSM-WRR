...
data_stan = xr.open_dataset(data_loc+'share_tree_additional_treecover_percentage_00/201804010000.LDASOUT_DOMAIN1')
data_plot = xr.open_dataset(data_loc+'share_tree_additional_treecover_percentage_70/201804010000.LDASOUT_DOMAIN1')
# data_update = xr.open_dataset(data_loc+'share_tree_percent_over_urban_20/201804010000.LDASOUT_DOMAIN1')
...
# data_update = data_update.assign_coords(Time=d)
...
# data_update = data_update.sel(Time=drop1)
...
plt.savefig(save_loc+'typical_diel_heatflux_Sharetree.png',dpi=500)
plt.close()
####
...
HFX_data1 = data_stan.HFX.isel(west_east=0) * 0.15 +  data_plot.HFX.isel(west_east=0)* 0.35  + data_plot.HFX.isel(west_east=1) * 0.5
...
HFX_data1 = data_stan.LH.isel(west_east=0) * 0.15 +  data_plot.LH.isel(west_east=0)* 0.35  + data_plot.LH.isel(west_east=1) * 0.5
...
plt.savefig(save_loc+'extreme_diel_heatflux_Sharetree.png',dpi=500)
