...
sns.set_style('ticks')
data_hfx_siltloam = np.loadtxt('../../intermediate-data/figure7/extract_data_tree_shift/HFX_extracted_max_min_shift_tree.csv',delimiter=',')
data_lh_siltloam = np.loadtxt('../../intermediate-data/figure7/extract_data_tree_shift/LH_extracted_max_min_shift_tree.csv',delimiter=',')

print(data_lh_siltloam[0,0] - np.max(data_lh_siltloam[0,-1]))
...
plt.tight_layout()
plt.savefig('./peak_heatfluxes_and_IQR_shift.png',dpi=500)
