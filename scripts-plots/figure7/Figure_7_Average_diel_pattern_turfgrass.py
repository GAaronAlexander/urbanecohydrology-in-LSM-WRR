...
data_stan = xr.open_dataset(data_loc+'turf_grass_three_season/201804010000.LDASOUT_DOMAIN1')
data_plot = xr.open_dataset(data_loc+'turfgrass_with_some_disconnect_60/201804010000.LDASOUT_DOMAIN1')
...
HFX_data1 = data_stan.HFX.isel(west_east=0) * 0.3 +  data_stan.HFX.isel(west_east=1)* 0.7  
...
HFX_data1 = data_stan.LH.isel(west_east=0) * 0.3 +  data_stan.LH.isel(west_east=1)* 0.7 
...
plt.savefig(save_loc+'typical_diel_heatflux_turfgrass.png',dpi=500)
plt.close()
####
...
HFX_data1 = data_plot.HFX.isel(west_east=0) * 0.3 +  data_plot.HFX.isel(west_east=1)* 0.7  
...
HFX_data1 = data_plot.LH.isel(west_east=0) * 0.3 +  data_plot.LH.isel(west_east=1)* 0.7  
...
plt.savefig(save_loc+'extreme_diel_heatflux_turfgrass.png',dpi=500)
