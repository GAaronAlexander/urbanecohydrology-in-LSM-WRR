...
!-------------------------------------------------------------------------------
   ...
   DO ITERATION=1,100
       ...
       CALL TRANSP  (ETTR,ETR,ECR,SHDFAC,EPGR,CMCRP,CFACTR,CMCMAX,LAI,RSMIN,RSMAX,RGL,SX, &
                     TGRP,TA,QA,SMRP,SMCWLT,SMCREF,CPP,PS,CHGR,EPSV,x,NROOT,NGR,DZGR, &
                     ZSOILR,HS)
...
!    TGP=350.
     ...
     DO ITERATION=1,20
       ...
       TB = TBP + DTB
       TG = TGP + DTG
       WRITE(*,*) ITERATION, 'TB =', TB, 'TBP = ', TBP, 'DTB = ', DTB, 'QS0B = ', QS0B, 'RB =', RB
       TBP = TB
       TGP = TG
...
!===========================================================================
!  TRANSP
!  CALCULATE EVAPOTRANSPIRATION FOR VEGETATION SURFACE
!===========================================================================
