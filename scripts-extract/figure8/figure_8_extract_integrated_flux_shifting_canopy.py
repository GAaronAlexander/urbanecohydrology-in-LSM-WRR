...
save_loc = '../../data/extracted_data_shifting_canopy/season_heatflux_heatmap_shifting/'
...
# 	# create a figure
	...
	heat_flux_l = (data_turf.LH[:,0,1]*((i/2)/100) + data.LH[:,0,1]*(((100-i)/2)/100) + data.LH[:,0,0]*((i/2)/100) + new_data.LH[:,0,0]*((100-i)/2)/100)*300 # now in j/m^2
	sens_flux_l = (data_turf.HFX[:,0,1]*((i/2)/100) + data.HFX[:,0,1]*(((100-i)/2)/100) + data.HFX[:,0,0]*((i/2)/100) + new_data.HFX[:,0,0]*((100-i)/2)/100)*300 # now in j/m^2
...
np.savetxt(save_loc+'extracted_H_data_2020_all.csv',data_final_H,delimiter=',')
np.savetxt(save_loc+'extracted_H_data_difference_2020_all.csv',data_final_diff_H,delimiter=',')

np.savetxt(save_loc+'extracted_LH_data_2020_all.csv',data_final_LH,delimiter=',')
np.savetxt(save_loc+'extracted_LH_data_difference_2020_all.csv',data_final_diff_LH,delimiter=',')
