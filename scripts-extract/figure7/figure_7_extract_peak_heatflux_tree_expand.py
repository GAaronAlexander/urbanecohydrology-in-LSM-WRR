...
data_location = '/Volumes/Untitled/Integragting_LID_into_LSM/three_season_long_simulations_correct/three_season_tree_expand/'
...
save_loc = '../../intermediate-data/figure7/extract_data_tree_expand/'
...
for i,n in enumerate(data_directory_list):
	...
	HFX_data_loop = data_stan.HFX.isel(west_east=0)* percentage_pavement  + data_loop.HFX.isel(west_east=1)*percentage_over_yard + data_loop.HFX.isel(west_east=0)*Percentage_over_pavement_tree 
	LH_data_loop = data_stan.LH.isel(west_east=0)* percentage_pavement  + data_loop.LH.isel(west_east=1)*percentage_over_yard + data_loop.LH.isel(west_east=0)*Percentage_over_pavement_tree 
...
np.savetxt(save_loc+'HFX_extracted_max_min_tree_expand.csv',data_extracted_HFX,delimiter=',')
np.savetxt(save_loc+'LH_extracted_max_min_tree_expand.csv',data_extracted_LH,delimiter=',')