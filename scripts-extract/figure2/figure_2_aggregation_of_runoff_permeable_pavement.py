...
for i,ll in enumerate(data_directory_list):
	...
	percentage_pavement_permeable = (i)/100
	print(percentage_pavement, percentage_pavement_permeable)
	...
	if i == 0: 
		data_standard_rain = data_standard.RUNSFXY[:,0,0]*300*percentage_pavement*rain_windows
	else: 
		data_standard_rain = data_loop.RUNSFXY[:,0,1]*rain_windows*300*percentage_pavement_permeable 
...
np.savetxt('../../intermediate-data/figure2/three_season_permeable_pavement_var_depth_12hourwindow.csv',data_to_save,delimiter=',')
